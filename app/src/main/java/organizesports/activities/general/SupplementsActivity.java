...
public class SupplementsActivity extends AppCompatActivity implements DataAdapter.DataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplments);
    ...
    private void getData() {
        ...
        new DataController().getSupplementsAlways(new DataCallback() {
            @Override
            public void onSuccess(ArrayList<DataModel> exerciseTypes) {
                ...
                if (currentList.size() > 0) {
                    ...
                    if (adapter == null || adapter.getData().size() == 0) {
                        adapter = new DataAdapter(currentList, SupplementsActivity.this);
                        recyclerView.setAdapter(adapter);
                        recyclerView.setLayoutManager(new LinearLayoutManager(SupplementsActivity.this));
                    } else {
            ...
            public void onFail(String error) {
                loadingHelper.dismissLoading();
                Toast.makeText(SupplementsActivity.this, error, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void deleteItem(int position) {
        new DataController().delete(adapter.getData().get(position), new DataCallback() {
            @Override
            public void onSuccess(ArrayList<DataModel> exerciseTypes) {
                Toast.makeText(SupplementsActivity.this, "Deleted!", Toast.LENGTH_LONG).show();
            }
